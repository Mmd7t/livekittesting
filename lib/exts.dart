...
extension LKExampleExt on BuildContext {
  ...
  Future<bool?> showPublishDialog() => showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text('Would you like to publish your Camera & Mic ?', style: const TextStyle(
                color: Colors.white,
                fontSize: 16,
          ...
          actions: [
            TextButton(
              ...
              child: const Text('NO', style: const TextStyle(
                color: Colors.white,
                fontSize: 16,
                fontWeight: FontWeight.bold,
              ),),
            ...
            TextButton(
              ...
              child: const Text('YES', style: const TextStyle(
                color: Colors.white,
                fontSize: 16,
                fontWeight: FontWeight.bold,
              ),),
